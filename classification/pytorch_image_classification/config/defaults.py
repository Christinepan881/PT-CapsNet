...
config.model.TS_CapsNet = ConfigNode()


config.model.caps_resnet = ConfigNode()
config.model.caps_resnet.depth = 110  # for cifar type model
config.model.caps_resnet.n_blocks = [2, 2, 2, 2]  # for imagenet type model
config.model.caps_resnet.block_type = 'basic'
config.model.caps_resnet.initial_channels = 8

config.model.caps2_resnet = ConfigNode()
config.model.caps2_resnet.depth = 110  # for cifar type model
config.model.caps2_resnet.n_blocks = [2, 2, 2, 2]  # for imagenet type model
config.model.caps2_resnet.block_type = 'basic'
config.model.caps2_resnet.initial_channels = 8

config.model.caps2211_resnet = ConfigNode()
config.model.caps2211_resnet.depth = 110  # for cifar type model
config.model.caps2211_resnet.n_blocks = [2, 2, 2, 2]  # for imagenet type model
config.model.caps2211_resnet.block_type = 'basic'
config.model.caps2211_resnet.initial_channels = 8
...
config.model.caps2211_wrn = ConfigNode()
config.model.caps2211_wrn.depth = 28  # for cifar type model
config.model.caps2211_wrn.initial_channels = 16
config.model.caps2211_wrn.widening_factor = 10
config.model.caps2211_wrn.drop_rate = 0.0
...
config.model.caps2211_densenet = ConfigNode()
config.model.caps2211_densenet.depth = 100  # for cifar type model
config.model.caps2211_densenet.n_blocks = [6, 12, 24, 16]  # for imagenet type model
config.model.caps2211_densenet.block_type = 'bottleneck'
config.model.caps2211_densenet.growth_rate = 8
config.model.caps2211_densenet.drop_rate = 0.0
config.model.caps2211_densenet.compression_rate = 0.5
