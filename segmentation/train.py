...
class Trainer(object):
    ...
    def training(self, epoch):
        ...
        mIoU2 = self.evaluator.Mean_Intersection_over_Union_noBkgrd()
        FWIoU = self.evaluator.Frequency_Weighted_Intersection_over_Union()
        self.writer.add_scalar('train/total_loss_epoch', train_loss, epoch)
        self.writer.add_scalar('train/mIoU', mIoU, epoch)
        self.writer.add_scalar('train/mIoU2', mIoU2, epoch)
        ...
        print("Acc:{}, Acc_class:{}, mIoU:{}, mIoU2:{}, fwIoU: {}".format(Acc, Acc_class, mIoU, mIoU2, FWIoU))
    ...
    def validation(self, epoch):
        ...
        self.writer.add_scalar('val/mIoU2', mIoU2, epoch)
    ...
    def testing(self, epoch):
        ...
        self.writer.add_scalar('test/mIoU2', mIoU2, epoch)
...
def main():
    ...
    parser.add_argument('--dataset', type=str, default='pascal',
                        #choices=['pascal', 'coco', 'cityscapes', 'airbem', 'airbem_old_aug', 'airbemold'],
    ...
    # optimizer params
    parser.add_argument('--lr_step', type=int, default=None, metavar='LR',
                        help='lr_step (default: None)')
    parser.add_argument('--warmup_epochs', type=int, default=None, metavar='LR',
                        help='warmup_epochs (default: None)')
